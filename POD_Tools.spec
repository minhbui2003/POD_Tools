...
a = Analysis(
    ...
    datas=[('assets/Logo_bg.png', 'assets'), ('assets/icon_crawl.png', 'assets'), ('assets/icon_resize.png', 'assets'), ('assets/guid_get_gemini_key.pdf', 'assets'), ('assets/checkmark.svg', 'assets')] + extra_datas,
